...
@section('content')
  ...
  <div class="untree_co-hero overlay" style="background-image: url('public/images/img-school-1-min.jpg');">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="0">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{ asset('public/images/staff_1.jpg') }}" alt="Image" class="img-fluid"></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{ asset('public/images/staff_2.jpg') }}" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
        ...
        <div class="col-12 col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4" data-aos="fade-up" data-aos-delay="200">
          <div class="staff text-center">
            <div class="mb-4"><img src="{{ asset('public/images/staff_3.jpg') }}" alt="Image" class="img-fluid"></div>
            <div class="staff-body">
