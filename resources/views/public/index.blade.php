...
@section('content')
  ...
  <div class="untree_co-hero overlay" style="background-image: url('public/images/hero-img-1-min.jpg');">
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <figure class="img-wrap-2">
            <img src="{{ asset('public/images/teacher-min.jpg') }}" alt="Image" class="img-fluid">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('public/images/img-school-1-min.jpg') }}" alt="Image" class="img-fluid"></a>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('public/images/img-school-2-min.jpg') }}" alt="Image" class="img-fluid"></a>
            <div class="custom-media-body">
              <div class="d-flex justify-content-between pb-3">
                <div class="text-primary"><span class="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div class="review"><span class="icon-star"></span> <span>4.8</span></div>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="custom-media">
            <a href="#"><img src="{{ asset('public/images/img-school-3-min.jpg') }}" alt="Image" class="img-fluid"></a>
            <div class="custom-media-body">
              <div class="d-flex justify-content-between pb-3">
                <div class="text-primary"><span class="uil uil-book-open"></span> <span>43 lesson</span></div>
                <div class="review"><span class="icon-star"></span> <span>4.8</span></div>
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
            ...
            <img src="{{ asset('public/images/img-school-4-min.jpg') }}" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-stretch">
        <div class="col-lg-6"  data-aos="fade-up" data-aos-delay="100">
          <div class="media-h d-flex h-100">
            <figure>
              <img src="{{ asset('public/images/img-school-1-min.jpg') }}" alt="Image">
            </figure>
        ...
        <div class="col-lg-6"  data-aos="fade-up" data-aos-delay="200">
          <div class="media-h d-flex h-100">
            <figure>
              <img src="{{ asset('public/images/img-school-2-min.jpg') }}" alt="Image">
            </figure>
            <div class="media-h-body">
          ...
          <div class="owl-carousel wide-slider-testimonial">
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('public/images/person_1.jpg') }}" alt="Free template by TemplateUX">
                  <h3>John Doe</h3>
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('public/images/person_2.jpg') }}" alt="Free template by TemplateUX">
            ...
            <div class="item">
              <blockquote class="block-testimonial">
                ...
                <div class="author">
                  <img src="{{ asset('public/images/person_3.jpg') }}" alt="Free template by TemplateUX">
                  <h3>Rob Smith</h3>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 mr-auto mb-5 mb-lg-0"  data-aos="fade-up" data-aos-delay="0">
          <img src="{{ asset('public/images/img-school-5-min.jpg') }}" alt="image" class="img-fluid">
        </div>
                ...
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{ asset('public/images/img-school-1-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{ asset('public/images/img-school-2-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
                      <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
                      <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion_1">
                <div class="accordion-body">
                  <div class="d-flex">
                    <div class="accordion-img mr-4">
                      <img src="{{ asset('public/images/img-school-3-min.jpg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div>
